...
10. 吸附线的显示
  ...
  在参数化设计工具中看什么时候加载2254
  在new_document文件的 loadFileData 中加载 uuid为 1a504438-6724-44c1-a703... 文档时的dependentDataInfo中

  问题在model3d调用updateMeta时
  获取替换的材质,获取旧的应该从2254上拿, 但是此时getParts是空的
